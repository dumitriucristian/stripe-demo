...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\Pay' => 'getPayService',
    ...
    protected function getDefaultControllerService()
    {
        ...
        $this->services['App\\Controller\\DefaultController'] = $instance = new \App\Controller\DefaultController(($this->services['session'] ?? $this->getSessionService()));
    ...
    /**
     * Gets the public 'App\Controller\Pay' shared autowired service.
     *
     * @return \App\Controller\Pay
     */
    protected function getPayService()
    {
        include_once \dirname(__DIR__, 4).'/src/Controller/Pay.php';

        return $this->services['App\\Controller\\Pay'] = new \App\Controller\Pay();
    }
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('n3rp2+o-pA', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mZF-c028r-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
